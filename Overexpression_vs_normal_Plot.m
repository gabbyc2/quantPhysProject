...
ku1 = 5e-3; % Rate constant for EGF-EGFR-HER2 dissociation ((#cell)^−1 min^−1)
kc1 = 0.5; % can be adjusted
ku2 = 1e-3; % Rate constant for EGF-EGFR-HER2 dissociation ((#cell)^−1 min^−1)
kc2 = 0.1; % can be adjusted
